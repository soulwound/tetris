...
fontpath = './arcade.ttf'
fontpath_mario = './personal-computer.ttf'
...
shape_colors = [(2, 49, 94), (0, 69, 126), (47, 112, 175), (185, 132, 140), (128, 100, 145), (164, 230, 244),
                (105, 152, 163)]
...
def draw_window(surface, grid, score=0, last_score=0):
    ...
    pygame.font.init()
    font = pygame.font.Font(fontpath_mario, 40)
    ...
    label_hi = font.render('HIGH SCORE ' + str(last_score), True, (255, 255, 255))
